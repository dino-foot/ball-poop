...
export default class Preload extends Phaser.Scene {
	preload() {
		...
		this.load.image(TextureKeys.VirusMagenta, 'assets/game/virus_magenta.png')
		...
		this.load.audio(AudioKeys.MusicLoop, 'assets/game/music/imminent-threat-loop-var.mp3')
